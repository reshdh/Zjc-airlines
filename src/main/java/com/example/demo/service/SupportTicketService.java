...
public class SupportTicketService {
    ...
    public Page<SupportTicket> listTicketsByUser(String userName, int page, int size) {
        Pageable pageable = PageRequest.of(Math.max(page, 0), Math.max(size, 1));
        return supportTicketRepository.findAllByUserNameOrderByCreatedAtDesc(userName, pageable);
    }
