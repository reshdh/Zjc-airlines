...
![首页与航班检索](docs/images/home-flight-search.png)

### 订票与支付确认

![订票与支付确认](docs/images/booking-payment.png)

### 退票申请

![退票申请](docs/images/refund-request.png)

### 管理员航班管理

![管理员航班管理](docs/images/admin-flight-management.png)

### 工单中心

![工单中心](docs/images/support-ticket-management.png)
