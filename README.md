...
ZJC 航空公司机票预订系统是一个前后端分离的航空票务管理平台。项目以机票预订业务为核心，包含用户端订票流程、管理员后台、订单与退改签管理、工单反馈、钱包支付模拟和 AI 客服接口接入。

项目中的业务数据均为模拟数据，主要用于功能演示和本地开发测试。
...
这是一个演示性质的订票系统项目。代码中包含 mock token、模拟支付、演示数据和项目文档，适合用于本地运行、接口测试和功能流程查看。
